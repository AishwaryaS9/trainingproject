...
import styles from "../styles/viewprojecttypedetails.module.css";
import Image from 'next/image'
import CloseButton from '../public/closebutton.png'


const Viewprojecttypedetails = ({ openViewModal, handleCloseViewModal }: any) => {
...
>
    <Fade in={openViewModal}>
        <Box className={styles.projecttypemodalcontainer}>
            <IconButton
...
export default Viewprojecttypedetails