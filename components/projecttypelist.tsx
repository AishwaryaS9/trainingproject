...
import styles from '../styles/projecttypelist.module.css'
...
const Projecttypelist = () => {
  ...
  const handleMenu = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    const [projectTypeData, setProjectTypeData] = useState<any[]>(ProjectTypeData);
